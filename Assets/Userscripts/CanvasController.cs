...
public class CanvasController : MonoBehaviour
{
    ...
    {   
        ...
        public RawImage Image;          // Das Bild
    }
    ...
    private void Start()
    {
        ...
        buttonContents[0] = new CanvasContent
        {
            ...
            Image = Resources.Load<RawImage>("Images/Image1")
        };
        ...
        buttonContents[1] = new CanvasContent
        {
            ...
            Image = Resources.Load<RawImage>("Images/Image2")
        };
    ...
    public void UpdateCanvas(int contentIndex)
    {
        ...
        if (contentIndex >= 0 && contentIndex < buttonContents.Length)
        {
           ...
           // Bild befüllen
            if (Picture != null)
                Picture.sprite = buttonContents[contentIndex].Image;
                */
        }
        else
        {
